...
const Sec5 = () => {
  ...
  return (
    <div className={`sec5 ${isVisible ? 'visible' : ''}`} ref={sectionRef} style={{ overflow: 'hidden' }}>
      <div className='sec5maindiv' style={{ display: 'flex', placeContent: 'space-between', rowGap: '60px', flexWrap: 'wrap' }}>
        ...
        <div className='col-lg-7 col-md-7 col-sm-12' style={{ display: 'flex', flexDirection: 'column', gap: '28px', paddingRight: '0px' }}>
          ...
          <div style={{ display: 'flex', rowGap: '50px', flexWrap: 'wrap', marginTop: '40px' }}>
            <div className='col-lg-6 col-md-6 col-sm-12 sec5box' style={{ display: 'flex', gap: '20px' }}>
              <div style={{ alignSelf: 'center' }}><img src={worldsbest} alt=''></img></div>
            ...
            <div className='col-lg-6 col-md-6 col-sm-12 sec5box' style={{ display: 'flex', gap: '20px' }}>
              <div style={{ alignSelf: 'center' }}><img src={baristas} alt=''></img></div>
            ...
            <div className='col-lg-6 col-md-6 col-sm-12 sec5box' style={{ display: 'flex', gap: '20px' }}>
              <div style={{ alignSelf: 'center' }}><img src={freshness} alt=''></img></div>
            ...
            <div className='col-lg-6 col-md-6 col-sm-12 sec5box' style={{ display: 'flex', gap: '20px' }}>
              <div style={{ alignSelf: 'center' }}><img src={synphony} alt=''></img></div>
